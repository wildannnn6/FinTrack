...
@section('title', 'Daftar - Fintrack')

@section('page-title', 'Buat Akun Baru')
@section('page-subtitle', 'Daftar sekarang dan mulai kelola keuangan Anda')

@section('auth-content')
<form class="mt-8 space-y-6" action="{{ route('signup.auth') }}" method="POST">
    @csrf
    <div class="space-y-4">
        <div>
...
@section('auth-footer')
<a href="{{ route('login.index') }}" class="font-medium text-purple-600 hover:text-purple-500">
