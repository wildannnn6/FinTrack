...
class DebtController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.advance.debts.index', [
            'debts' => $this->debts,
    ...
    public function edit($id)
    {
        ...
        if (!$debt) {
            return redirect()->route('advance.debts.index')->with('error', 'Data tidak ditemukan.');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('advance.debts.index')->with('success', 'Data hutang/piutang berhasil diperbarui!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('advance.debts.index')->with('success', 'Data hutang/piutang berhasil dihapus!');
    }
